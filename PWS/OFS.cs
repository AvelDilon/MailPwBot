...
namespace PwBot
{
    class OFS
    {
        ...
        public static void Init()
        {
            ...
            Put("MS_OFS", "0x1C");
            //------------------------------------------------------
            Put("LOCATION_ID", "0x94");
            Put("LOCATION_NAME", "0x60");
            Put("LOCATION_NAME_OFS", "0x4");
            //------------------------------------------------------
            Put("SendPacket", "0x7EDB30");
            Put("GUI", "0x9E1400");
            Put("NTL_CriticalSectionPtr", "0xE4C110");
            Put("NTL_EnterCriticalSection", "0xC7F250");
            Put("NTL_LeaveCriticalSection", "0xC7F254");
            //------------------------------------------------------
            Put("Gui_O1", "0x18");
            Put("Gui_O2", "0x8");
            ...
            Put("PlayerName", "0x750");
            Put("Player_LocX", "0x3C");
            Put("Player_LocY", "0x44");
            Put("Player_LocZ", "0x40");
            Put("Player_ID", "0x4B8");
            Put("Player_Lvl", "0x4C4");
            Put("Player_WalkMode", "0x760");
            Put("Player_FlyId", "0x5F8");
            Put("Player_EqFairyId", "0x638");
            Put("Player_EqFairy_Arr", "0x408");
            Put("Player_EqFairy_Lvl", "0x70");
            Put("Player_EqFairy_FSC", "0x74");
            Put("Player_Action_Struct", "0x15C4");
            //------------------------------------------------------
            Put("p_ActionStruct", "0x154C");
            Put("p_Quests", "0x15CC");
            //------------------------------------------------------
            Put("p_Inventory", "0x1160");
